...
```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=be47e4bd-902a-4fcf-90d3-b0920087c849&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player"></iframe>
```

Watch Lecture Part 2

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=c05d4cbb-cf04-437e-8d98-b0920089f555&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player"></iframe>
```

Watch Lecture Part 3

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=a177a0a9-67c5-4700-9a98-b092008e0cfc&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player"></iframe>
```

Watch Lecture Part 4

```{=html}
<iframe src="https://lancaster.cloud.panopto.eu/Panopto/Pages/Embed.aspx?id=237ed51b-aa37-4e10-9f3b-b0920091b16b&autoplay=false&offerviewer=true&showtitle=true&showbrand=true&captions=false&interactivity=all" height="405" width="720" style="border: 1px solid #464646;" allowfullscreen allow="autoplay" aria-label="Panopto Embedded Video Player"></iframe>
```

Download the lecture slides [here](data/Week_1/week1_lecture_student_slides.pptx)
...
-   You have worked through the online "prelab" preparation materials - [Here is the one for Week 1](https://ma-rconnect.lancs.ac.uk/W1_prelab){target="_blank"}
...
The survey runs [by following this link](https://lancasteruni.eu.qualtrics.com/jfe/form/SV_5cNHoTIRd5ZVYlE){target="_blank"}

## Post - lab recap: The slides we used

Want to see again the introduction slides that we used in the Levy lab? They are [available here](data/Week_1/week_1_levylab_slides.pptx)
