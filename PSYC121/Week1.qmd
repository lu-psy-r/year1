...
-   You have worked through the online "prelab" preparation materials - [You can access the link for Week 1 here](https://ma-rconnect.lancs.ac.uk/Psych121_week_1){target="_blank"}
...
**You do NOT need to purchase a copy of this book**, as it is available online [from the library pages](https://onesearch.lancaster-university.uk/permalink/f/cssk39/44LAN_ALMA_DS51180136050001221){target="_blank"}. The book covers principles of statistics as well as some tutorials on using R.
...
1.  Download the "zip" file by [clicking this link](data/Week_1/week_1_2025.zip)
...
It's important to stop and think about what this does. When we use "\<-", we create the variable label on the left (`Analysis_week1_data`) and we give it those numbers on the right. The name`Analysis_week1_data` is largely arbitrary: try use a variable of your own naming (your own name?) instead - and then use that alternative name for the other commands. QUICK TIP: there is a keyboard shortcut, alt+hyphen, which will give you the assignment arrow in R. Get used to this as it will save you lots of time in the long run.
...
The survey runs [by following this link](https://lancasteruni.eu.qualtrics.com/jfe/form/SV_4YnySR3Qa8G1kh0){target="_blank"}
