---
title: 3. DVs and IVs in RStudio (2024)
...
```
Download the lecture slides [here](data/Week_3/week%203%20slides2024.pptx)
...
Step 2. Bring the `week3.zip` file into R Studio server. Like last week, upload the zip file, and launch the R script. [You can get the file here](data/Week_3/week_3_2024.zip)
...
Now, let's turn to the guesses made about median salary in the UK. We can get the data from the file `wages2024.csv` (you will need to adapt the code we used above for the weight estimation file so that it will load in the wages data, and in what follows the assumption is your new variable name is called `wages`)
