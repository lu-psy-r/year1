...
-   Make sure you have access to the `week_4_2024.zip` file for the RStudio server. [You can get the file here](data/Week_4/week_4_2024.zip).
...
[Information about the z-score questions are here](data/Week_4/Week_4_z-scores_answers.pdf)
