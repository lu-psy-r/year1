...
You can download the lecture slides [here](data/Week_6/PSYC121_wk6_slides_2025.pptx)

## Reading

[Chapter 8 of Howell](https://onesearch.lancaster-university.uk/permalink/44LAN_INST/1438dph/alma9930907993701221){target="_blank"}.

## Pre-lab work

-   Ensure you have watched the above lecture content for Week 6.

-   Complete the short learnr tutorial which will introduce you to running the **binomial tests** in R. [You can find it here](https://ma-rconnect.lancs.ac.uk/PSYC121_W6_prep/){target="_blank"}.
...
![](images/wk6/new_rmd.png){fig-alt="screenshot of r markdown menu"}
...
![](images/wk6/add_chunk.png){fig-alt="adding a chunk to Rmarkdown"}
