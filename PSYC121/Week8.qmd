...
**Online tutorial**: You must make every attempt to complete this before the lab! To access the [**pre-lab tutorial click here**](https://ma-rconnect.lancs.ac.uk/PSYC121_Week_8_Quiz_2025/){target="_blank"} (on campus, or VPN required)

**Getting ready for the lab class**

- Create a folder for Week 8 and download the [Week_8 csv file](data/Week_8/stroop_wk8_2025.csv) file and upload it into this new folder in RStudio Server.
...
1.  Create a new Rmarkdown document. If you're unsure about this step, see the instructions from Week 6 (or 7).
...
You can access a set of quiz questions related to this week [here.](https://ma-rconnect.lancs.ac.uk/PSYC121_Week_8_Quiz/){target="_blank"}
