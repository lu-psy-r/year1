...
# d_stroop <- read_csv("data/Week_8/stroop_wk8_2024.csv")
...
7. You should have **removed 1 row of data** to make an object with 102 rows. Make a note of this in your R markdown document. 
...
var.test(x = north_condition$z_imm, y = south_condition$z_imm, data = data_wk9_f)

# run unrelated samples t-test
t.test(x = north_condition$z_imm, y = south_condition$z_imm, 
       paired = FALSE,
       var.equal = TRUE) # you'll need to set this to TRUE or FALSE depending on what you found in var.test

```

6. If you've done this correctly, you should have a **t-statistic = --0.04763**. Examine the p-value and discuss on your table what this means. Write a line in your .Rmd to formally state the result of the t-test (look at last week for the format). Describe what this result means in your own words.
