...
north_condition <- data_wk9_f %>% filter(home_location_in_UK == "North")
south_condition <- data_wk9_f %>%filter(home_location_in_UK == "South")
...
6. If you've done this correctly, you should have a **t-statistic = -1.0533**. Examine the p-value and discuss on your table what this means. Write a line in your .Rmd to formally state the result of the t-test (look at last week for the format). Describe what this result means in your own words.
