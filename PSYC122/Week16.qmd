...
When you have completed all of the lab content, you will want to check your answers with our completed version of the script for this week.

You will be able to see all the code and all the answers in `PSYC122-w16-workbook-answers.Rmd`. This will be made available after the final lab session has taken place.

::: callout-tip
- You can now download the script [PSYC122-w16-workbook-answers.Rmd](data/week16/PSYC122-w16-workbook-answers.Rmd)
:::
...
```{=html}
<iframe allow="autoplay; fullscreen" width="640" height="360" src="https://estream.lancaster.ac.uk/Embed.aspx?id=93900&code=Js~7fkHIygIfPGYBhxbpRV5AdWomAQRCddFv6Oqat8l8AVGfObZqTgoKdtEp9rO7uzcueURjQjoGATjChkqIUREhd%22 frameborder="0" allowfullscreen></iframe>
```
