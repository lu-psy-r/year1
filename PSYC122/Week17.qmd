...
Click on the link: [122_week17_for_students.zip](data/week17/122_week17_for_students.zip) to download the data files folder. Then upload the contents to the new folder you created in RStudio Server.
...
Get the `PSYC122-w17-how-to.Rmd` how-to guide

Click on the link: [PSYC122-w17-how-to.Rmd](data/week17/PSYC122-w17-how-to.Rmd) to download the `PSYC122-w17-how-to.Rmd` guide.
:::
...
::: callout-tip
If you are unsure about what you need to do, look at the advice in `PSYC122-w17-how-to.Rmd` on how to do the tasks, with examples on how to write the code.
:::
...
- You can look at the `how-to` guide or review previous materials from previous weeks for more advice.
:::
...
::: callout-tip
- You can download the script by clicking on the link: [PSYC122-w17-workbook-answers.Rmd](data/week17/PSYC122-w17-workbook-answers.Rmd).
:::
...
You can see all the code and all the answers in `PSYC122-w17-workbook-answers.Rmd`.
...
```{=html}
<iframe src="https://livelancsac-my.sharepoint.com/personal/groen_lancaster_ac_uk/_layouts/15/embed.aspx?UniqueId=713bf0ef-051d-4738-b7f9-3cca6d02011e&nav=%7B%22playbackOptions%22%3A%7B%22startTimeInSeconds%22%3A2100%7D%7D&embed=%7B%22ust%22%3Atrue%2C%22hv%22%3A%22CopyEmbedCode%22%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create" width="640" height="360" frameborder="0" scrolling="no" allowfullscreen title="PSYC122 - Online Q&A-20260227_142259UTC-Meeting Recording.mp4"></iframe>
```
