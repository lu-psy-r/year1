...
<!-- - You can download the script by clicking on the link: [PSYC122-w17-workbook-answers.Rmd](data/week17/PSYC122-w17-workbook-answers.Rmd) when it is available. -->

<!-- - Or by copying the code into the R `Console` window and running it to get the `PSYC122-w17-workbook-answers.Rmd` loaded directly into R: -->

<!-- ```{r eval=FALSE} -->
<!-- download.file("https://github.com/lu-psy-r/statistics_for_psychologists/blob/main/PSYC122/data/PSYC122-w17-workbook-answers.Rmd?raw=true", destfile = "PSYC122-w17-workbook-answers.Rmd") -->
<!-- ``` -->
:::
