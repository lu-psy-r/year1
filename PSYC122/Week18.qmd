...
Click on the link: [122-week18_for_students.zip](data/week18/122_week18_for_students.zip) to download the data files folder. Then upload the contents to the new folder you created in RStudio Server.
...
Get the `PSYC122-w18-how-to.Rmd` how-to guide

Click on the link: [PSYC122-w18-how-to.Rmd](data/week18/PSYC122-w18-how-to.Rmd) to download the `PSYC122-w18-how-to.Rmd` guide.
:::
...
::: callout-tip
If you are unsure about what you need to do, look at the advice in `PSYC122-w18-how-to.Rmd` on how to do the tasks, with examples on how to write the code.
:::
...
- Ratings of accuracy are ordinal (ordered categorical) data but, here, we choose to examine the average of participants' ratings of their own understanding of health information to keep our analysis fairly simple.
...
You can see example code, for a different model, for Step 4 in the `PSYC122-w18-how-to.Rmd`.
...
You can see example code, for a different model, for Step 5 in the `PSYC122-w18-how-to.Rmd`.
...
- You can download the script by clicking on the link:  [PSYC122-w18-workbook-answers.Rmd](data/week18/PSYC122-w18-workbook-answers.Rmd).
:::
...
You can see all the code and all the answers in `PSYC122-w18-workbook-answers.Rmd`.
...
<!-- ```{=html} -->
<!-- <iframe src="https://livelancsac-my.sharepoint.com/personal/shawej1_lancaster_ac_uk/_layouts/15/embed.aspx?UniqueId=c5eff857-4526-4902-b837-9ec34483aa76&embed=%7B%22ust%22%3Atrue%2C%22hv%22%3A%22CopyEmbedCode%22%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create" width="640" height="360" frameborder="0" scrolling="no" allowfullscreen title="PSYC122 Online Q&A Week 11-14 & 16 -19-20250306_140105-Meeting Recording.mp4"></iframe> -->
<!-- ``` -->
