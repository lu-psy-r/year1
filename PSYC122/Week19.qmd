...
::: callout-tip
The slides presented in the videos can be downloaded as a web page.
:::

- [The slides](data/week19/122-linear-model-interactions.html) exactly as presented (13 MB).
...
```{r eval=FALSE}
download.file("https://github.com/lu-psy-r/statistics_for_psychologists/blob/main/PSYC122/data/week18/study-one-general-participants.csv?raw=true", destfile = "all.data.csv")
```
::: 
...
## Code
```{r}
# -- center the variable if it has not been already
all.data$FACTOR3_centered <- all.data$FACTOR3 - mean(all.data$FACTOR3, na.rm = TRUE)
