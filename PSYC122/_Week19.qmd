...
3. Get the 2023-24 PSYC122 `2024-25_PSYC122-participants.csv` data
...
> Hint: Task 8 -- The plotting steps are explained in some detail in `2023-24-PSYC122-w17-how-to.Rmd` and you can see example code in `PSYC122-w19-how-to.Rmd`
