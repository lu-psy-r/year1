...
# ANSWER: 10 participants. The table 'intent_data' contains 87 observations, after we have applied the filter()
# function to include only those participants who did intend to return the paper-clips, the intent_recode
# table contains 77 observations.
...
#
# Run the code below to create the bar plot
...
# Write the code to run the chi-square analysis
...
# To calculate Cramer’s V we’re going to use the function cramersv() from the lsr package. The code mirrors the code
# used for the Chi-square test itself:
