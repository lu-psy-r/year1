...
1. There are fewer observations in the `study.two.gen` dataset than in the `study.122` data: this means that our estimate of the effect will be *more uncertain* because we have *less information* when we look at the `study.two.gen` data.
